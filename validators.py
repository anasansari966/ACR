...
# class MyClass(CaseInsensitiveModel):
#     my_property: str

# my_obj = parse_obj_as(MyClass, {"MY_PROPERTY": "hello"})
# print(my_obj)
...
class medical_history_Autonomic(BaseModel):
    patient_id: int
...
class medical_history_CoMorbidities(BaseModel):
    patient_id: int
    diabetes: int = 0
    hypertension: int = 0
    stroke: int = 0
...
class medical_history_Diagnosis(BaseModel):
    patient_id: int
    code: str = ""
    diagnosis: str = ""
    notes: str = ""
...
class medical_history_Implants(BaseModel):
    patient_id: int
    implant_name: str
    date_placed: str
    dos: str
...
class medical_history_MotorFunction(BaseModel):
    patient_id: int
...
class medical_history_Note(BaseModel):
    patient_id: int
    note: str


class medical_history_Seizures(BaseModel):
    patient_id: int
    seizures_status: int = 0
    note: str


class medical_history_Surgeries(BaseModel):
    patient_id: int
    procedure_name: str
    type: str
    dos: str
...
class medical_history_Symptoms(BaseModel):
    patient_id: int
    symptom: str
    side: str = ""
    area: str = ""
...
class PatientDetailsUpdate(BaseModel):
    ...
    Gender: str = ""
    DateOfBirth: str = ""
    Height: Annotated[float, Field(ge=1)] = 1
    Weight: Annotated[float, Field(ge=1)] = 1
    InsuranceType: str = ""
    PolicyNumber: str = ""
    MedicalRecord: str = ""
    HospitalRecord: str = ""
    ...
    def validate_gender(cls, value):
        ...
        if value not in valid_genders:
            raise PydanticCustomError(
                "In correct Gender",
                "{value} is not a correct gender",
                {"value": value},
            )
        return value


class PatientDetailsInsert(BaseModel):
    FirstName: str
    LastName: str
    Gender: str
    DateOfBirth: str
...
class PatientInfo_extension(BaseModel):
    # EMR_ID: int
    patient_id: int
    Procedure_Name: str = ""
    Hospital: str = ""
...
# class Case_setup_CranialMuscles(BaseModel):
#     Patient_id: int
#     III_IR: Side = ""
#     IV_SUP_OBLIQUE: Side = ""
#     V_MASSETER: Side = ""
